"""
Django settings for turing_saas_42591 project.
...
ROOT_URLCONF = 'turing_saas_42591.urls'
...
WSGI_APPLICATION = 'turing_saas_42591.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "turing_saas_42591 API",
    "DESCRIPTION": "API documentation for turing_saas_42591 App",
    "VERSION": "v1",
}
